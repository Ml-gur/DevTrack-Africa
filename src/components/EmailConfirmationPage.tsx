...
export default function EmailConfirmationPage({ 
  ...
  // Check for email confirmation in URL (Supabase auth)
  useEffect(() => {
    // Check if this page was reached after a successful email confirmation
    const urlParams = new URLSearchParams(window.location.search);
    if (urlParams.get('confirmed') === 'true') {
      console.log('✅ Email confirmed via URL parameter, redirecting to dashboard');
