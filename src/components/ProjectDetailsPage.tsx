...
// Extended Project type for the details page with legacy compatibility
interface ProjectWithLegacyCompat extends Project {
...
interface ProjectDetailsPageProps {
  project: ProjectWithLegacyCompat;
  tasks?: Task[];
  onBack: () => void;
  onUpdate?: (updatedProject: ProjectWithLegacyCompat) => void;
        ...
        <div className="space-y-6 mb-8">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              {/* Tech Stack */}
              {(project.techStack || project.tech_stack || []).length > 0 && (
              ...
              <div className="flex gap-3">
                {(project.githubUrl || project.github_repo) && (
                  <Button variant="outline" size="sm" asChild>
                    <a href={project.githubUrl || project.github_repo || ''} target="_blank" rel="noopener noreferrer">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-lg font-medium">{formatDate(project.startDate || project.created_at)}</div>
                  <div className="text-sm text-muted-foreground">
                    {(project.endDate || project.due_date) ? `Due ${formatDate(project.endDate || project.due_date || '')}` : 'No deadline set'}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Last updated {formatDate(project.updatedAt || project.updated_at)}
                  </div>
                </div>
              </div>
