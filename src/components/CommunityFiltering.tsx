...
const DEFAULT_PRESETS: FilterPreset[] = [
  ...
  },
  {
    ...
    description: 'Completed projects and demos',
    icon: '🎨',
    filter: { postType: 'showcase', timeframe: 'month', sortBy: 'popular' }
  },
  {
    id: 'african-devs',
            ...
            <Tabs defaultValue="basic" className="w-full">
              ...
              <TabsContent value="location" className="space-y-4">
                <div>
                  ...
                  <Select
                    value={customFilter.country || 'all'}
                    onValueChange={(value) => handleCustomFilterChange({ country: value === 'all' ? undefined : value })}
                  >
                    <SelectTrigger>
